...
//static double max_residual_distance = 0;
//static double max_residual_angle = 0;
static double max_final_cost = 0;
...
std::unique_ptr<transform::Rigid2d> LocalTrajectoryBuilder2D::ScanMatch(
  ...
  //std::cout<<"Entered Scan Match"<<std::endl; 
  ...
  if (pose_observation) {
   ...
   // if (residual_distance > max_residual_distance){
   //     max_residual_distance = residual_distance;
   // }
   // if (residual_angle > max_residual_angle){
   //     max_residual_angle = residual_angle;
   // }
    ...
    std::cout<<"no pose observation detected" <<std::endl;
  }
...
LocalTrajectoryBuilder2D::AddRangeData(
  ...
  //std::cout<< "Entered AddRangeData "<<std::endl;
  ...
  // Initialize kidnap detection module
//  if (options_.use_kidnap_detection()){
//    InitializeKidnapDetector();
//  }
    InitializeKidnapDetector();
  ...
  //std::cout<<"synchronized range data size is " << synchronized_data.ranges.size()<<std::endl;
  ...
  //std::cout<< "accumulated range data size is " << accumulated_range_data_.returns.size()<<std::endl;
...
LocalTrajectoryBuilder2D::AddAccumulatedRangeData(
    ...
    //std::cout<<"Entered AddAccumulatedRangeData"<<std::endl; 
...
void LocalTrajectoryBuilder2D::InitializeKidnapDetector() {
  if (kidnapdetection_ != nullptr){
    return;
  }

  kidnapdetection_ = common::make_unique<KidnapDetection>();
  kidnapdetection_->KidnapDetectionReset();
}
