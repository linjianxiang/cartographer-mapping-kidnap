...
class TrajectoryOptions {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.use_kidnap_detection = null;
      ...
      if (initObj.hasOwnProperty('use_kidnap_detection')) {
        this.use_kidnap_detection = initObj.use_kidnap_detection
      }
      else {
        this.use_kidnap_detection = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [use_kidnap_detection]
    bufferOffset = _serializer.bool(obj.use_kidnap_detection, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [use_kidnap_detection]
    data.use_kidnap_detection = _deserializer.bool(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'cb099d08a74fa3fa590cdec32c9ccfb7';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.use_kidnap_detection !== undefined) {
      resolved.use_kidnap_detection = msg.use_kidnap_detection;
    }
    else {
      resolved.use_kidnap_detection = false
    }
