...
class TrajectoryOptions(genpy.Message):
  _md5sum = "cb099d08a74fa3fa590cdec32c9ccfb7"
...
"""
  __slots__ = ['tracking_frame','published_frame','odom_frame','provide_odom_frame','use_kidnap_detection','use_odometry','use_nav_sat','use_landmarks','publish_frame_projected_to_2d','num_laser_scans','num_multi_echo_laser_scans','num_subdivisions_per_laser_scan','num_point_clouds','rangefinder_sampling_ratio','odometry_sampling_ratio','fixed_frame_pose_sampling_ratio','imu_sampling_ratio','landmarks_sampling_ratio','trajectory_builder_options_proto']
  _slot_types = ['string','string','string','bool','bool','bool','bool','bool','bool','int32','int32','int32','int32','float64','float64','float64','float64','float64','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       tracking_frame,published_frame,odom_frame,provide_odom_frame,use_kidnap_detection,use_odometry,use_nav_sat,use_landmarks,publish_frame_projected_to_2d,num_laser_scans,num_multi_echo_laser_scans,num_subdivisions_per_laser_scan,num_point_clouds,rangefinder_sampling_ratio,odometry_sampling_ratio,fixed_frame_pose_sampling_ratio,imu_sampling_ratio,landmarks_sampling_ratio,trajectory_builder_options_proto
    ...
    if args or kwds:
      ...
      if self.use_kidnap_detection is None:
        self.use_kidnap_detection = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_6B4i5d().pack(_x.provide_odom_frame, _x.use_kidnap_detection, _x.use_odometry, _x.use_nav_sat, _x.use_landmarks, _x.publish_frame_projected_to_2d, _x.num_laser_scans, _x.num_multi_echo_laser_scans, _x.num_subdivisions_per_laser_scan, _x.num_point_clouds, _x.rangefinder_sampling_ratio, _x.odometry_sampling_ratio, _x.fixed_frame_pose_sampling_ratio, _x.imu_sampling_ratio, _x.landmarks_sampling_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.provide_odom_frame, _x.use_kidnap_detection, _x.use_odometry, _x.use_nav_sat, _x.use_landmarks, _x.publish_frame_projected_to_2d, _x.num_laser_scans, _x.num_multi_echo_laser_scans, _x.num_subdivisions_per_laser_scan, _x.num_point_clouds, _x.rangefinder_sampling_ratio, _x.odometry_sampling_ratio, _x.fixed_frame_pose_sampling_ratio, _x.imu_sampling_ratio, _x.landmarks_sampling_ratio,) = _get_struct_6B4i5d().unpack(str[start:end])
      self.provide_odom_frame = bool(self.provide_odom_frame)
      self.use_kidnap_detection = bool(self.use_kidnap_detection)
...
def _get_struct_I():
    ...
    return _struct_I
_struct_6B4i5d = None
def _get_struct_6B4i5d():
    global _struct_6B4i5d
    if _struct_6B4i5d is None:
        _struct_6B4i5d = struct.Struct("<6B4i5d")
    return _struct_6B4i5d
