...
class StartTrajectoryRequest(genpy.Message):
  _md5sum = "2bf0c30c6cf307e01752dcc2b5514975"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_6B4i5d().pack(_x.options.provide_odom_frame, _x.options.use_kidnap_detection, _x.options.use_odometry, _x.options.use_nav_sat, _x.options.use_landmarks, _x.options.publish_frame_projected_to_2d, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.fixed_frame_pose_sampling_ratio, _x.options.imu_sampling_ratio, _x.options.landmarks_sampling_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.options.provide_odom_frame, _x.options.use_kidnap_detection, _x.options.use_odometry, _x.options.use_nav_sat, _x.options.use_landmarks, _x.options.publish_frame_projected_to_2d, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.fixed_frame_pose_sampling_ratio, _x.options.imu_sampling_ratio, _x.options.landmarks_sampling_ratio,) = _get_struct_6B4i5d().unpack(str[start:end])
      self.options.provide_odom_frame = bool(self.options.provide_odom_frame)
      self.options.use_kidnap_detection = bool(self.options.use_kidnap_detection)
...
class StartTrajectory(object):
  ...
  _md5sum = 'f30ab507b6603767eee6b06fd1a7e45a'
