...
TrajectoryOptions CreateTrajectoryOptions(
  ...
  options.use_kidnap_detection =
      lua_parameter_dictionary->GetBool("use_kidnap_detection");
...
bool FromRosMessage(const cartographer_ros_msgs::TrajectoryOptions& msg,
  ...
  options->use_kidnap_detection =msg.use_kidnap_detection;
...
cartographer_ros_msgs::TrajectoryOptions ToRosMessage(
  ...
  msg.use_kidnap_detection = options.use_kidnap_detection;
