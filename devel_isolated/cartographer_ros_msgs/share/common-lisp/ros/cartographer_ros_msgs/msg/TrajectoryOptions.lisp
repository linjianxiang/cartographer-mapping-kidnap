...
(cl:defclass <TrajectoryOptions> (roslisp-msg-protocol:ros-message)
  ((tracking_frame
   ...
   (provide_odom_frame
    ...
    :type cl:boolean
    :initform cl:nil)
   (use_kidnap_detection
    :reader use_kidnap_detection
    :initarg :use_kidnap_detection
    :type cl:boolean
    :initform cl:nil)
   (use_odometry
    :reader use_odometry
...
(cl:ensure-generic-function 'use_kidnap_detection-val :lambda-list '(m))
(cl:defmethod use_kidnap_detection-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartographer_ros_msgs-msg:use_kidnap_detection-val is deprecated.  Use cartographer_ros_msgs-msg:use_kidnap_detection instead.")
  (use_kidnap_detection m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrajectoryOptions>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'use_kidnap_detection) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryOptions>) istream)
  "Deserializes a message object of type '<TrajectoryOptions>"
    ...
    (cl:setf (cl:slot-value msg 'use_kidnap_detection) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectoryOptions>)))
  ...
  "cb099d08a74fa3fa590cdec32c9ccfb7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectoryOptions)))
  "Returns md5sum for a message object of type 'TrajectoryOptions"
  "cb099d08a74fa3fa590cdec32c9ccfb7")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TrajectoryOptions>))
  ...
  (cl:list 'TrajectoryOptions
    ...
    (cl:cons ':use_kidnap_detection (use_kidnap_detection msg))
